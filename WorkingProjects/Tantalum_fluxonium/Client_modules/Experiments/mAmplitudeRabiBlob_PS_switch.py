...
class LoopbackProgramAmplitudeRabi_PS_switch(RAveragerProgram):
...
class AmplitudeRabi_PS_switch(ExperimentClass):
    """
    ...
    def acquire(self, progress=False, debug=False, plotDisp = True, figNum = 1):
        ...
        for idx_amp in range(len(self.qubit_amps)):
            ...
            for idx_freq in range(len(self.qubit_freqs)):
                ...
                prog = LoopbackProgramAmplitudeRabi_PS_switch(self.soccfg, self.cfg)
