...
q_arr = data_SingleShot_HMM['data']['i_arr']
...
def update(frame):
    ...
    data['q_arr'] = np.append(data['q_arr'],data_SingleShot_HMM['data']['i_arr'])
...
global ani
ani = FuncAnimation(fig, update, blit=False, interval=1,cache_frame_data=False)
plt.show()
