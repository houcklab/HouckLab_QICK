...
#TODO write new transmission program
...
#TODO pick correct yoko


class TransVsFlux(ExperimentClass):
    """
    Measures cavity response as a function of flux, set via yoko voltage.
    """

    def __init__(self, soc=None, soccfg=None, path='', outerFolder='', prefix='', cfg=None, config_file=None,
                 progress=None, yoko=None):
