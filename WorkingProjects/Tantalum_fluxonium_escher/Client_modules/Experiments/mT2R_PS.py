...
class LoopbackProgramT2R_PS(RAveragerProgram):
...
class T2R_PS(ExperimentClass):
    """
    Use post selection at a thermal state (significant thermal population) to find T2
    """
    ...
    def acquire(self, progress=False, debug=False):
        ...
        for idx_wait in range(expt_cfg["wait_num"]):
            ...
            prog = LoopbackProgramT2R_PS(self.soccfg, self.cfg)
