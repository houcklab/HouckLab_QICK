...
BaseConfig={
        ...
        "adc_trig_offset": 0.525, #+ 1, #soc.us2cycles(0.468-0.02), # [Clock ticks]
        # Try varying adc_trig_offset from 100 to 220 clock ticks
        "cavity_LO": 0.0, # [MHz]
        "RFSOC_delay": 1.13e3, # [ns] Effective electrical delay generated by the RFSOC's two clocks in transmission measurements
       }
