...
ramp_params = {
    ...
    '2345_correlations': {'BS': {'BS_FF': [-26873, 11527, 13421, -17056, -15217, 9002, 10782, -24395]}},

    '2345_correlations_double': {'BS': {'BS_FF': [-26873, 13399, 13421, -17244, -15217, 7757, 10782, -24395]}},
