...
class T2EProgram(FFAveragerProgramV2):
    def _initialize(self, cfg):
        ...
        if cfg["stop_delay_us"]/self.cfg["expts"] < 0.00465:
            print(f"T2EProgram: WARNING: step size ({cfg["stop_delay_us"]}/{cfg["expts"]})is less than one cycle (4.65 ns)!!!")
...
class T2EMUX(ExperimentClass):
    ...
    def acquire(self, progress=False):
        ...
        prog = T2EProgram(self.soccfg, cfg=self.cfg, reps=self.cfg["reps"],
