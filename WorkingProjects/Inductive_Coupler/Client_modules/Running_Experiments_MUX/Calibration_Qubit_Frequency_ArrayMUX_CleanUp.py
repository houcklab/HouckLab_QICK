...
Spec_relevant_params = {'qubit_gain': 50,'SpecSpan': 12, 'SpecNumPoints': 131}#131}
...
voltage_frequency_dict = pickle.load(open('./../Helpers/Yoko_Voltages_0FAB_160.p', 'rb'))
...
for yoko_vector, qubit_freqs, cav_freqs in zip(yoko_voltages[:200], qubit_frequencies[:200], cavity_frequencies[:200]):
    ...
    pickle.dump([Yoko_Voltages, Qubit_Spec_Data, Cavity_IQ], open(
        'Z:\Jeronimo\Measurements\RFSOC_4Qubit_0F\Qubit_Yoko_Calibration\Qubit_Calibration_160_AB_2.p', 'wb'))
