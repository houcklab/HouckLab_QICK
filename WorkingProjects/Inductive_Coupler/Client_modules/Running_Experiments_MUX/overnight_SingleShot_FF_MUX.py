...
Qubit_Parameters = {
    ...
    '2': {'Readout': {'Frequency': 7269.9 - mixer_freq - BaseConfig["cavity_LO"] / 1e6, 'Gain': 6200,
          ...
          'Pulse_FF': [-4500, -9000, 8000, 0]},
    '3': {'Readout': {'Frequency': 7526.5 - mixer_freq - BaseConfig["cavity_LO"] / 1e6, 'Gain': 6000,
                      "FF_Gains": [-4500, -9000, 8000, 0], "Readout_Time": 2.5, "ADC_Offset": 0.3, 'cavmin': True},
          'Qubit': {'Frequency': 5282.7, 'Gain': 2060},
          'Pulse_FF': [-4500, -9000, 8000, 0]},
    ...
    'B': {'Qubit': {'Frequency': 5065.6, 'Gain': 3150},
          'Pulse_FF': [0, -4000, 1000, 0]},
...
# expt
FF_gain1_expt = 1240  # 8000
FF_gain2_expt = -4000
FF_gain3_expt = 235
FF_gain4_expt = 0


for Q, SweepFF in zip([2,3,5], [2,3,1]):
    Qubit_Readout = [Q]
    Qubit_Pulse = [Q]
    ...
    Run2ToneSpec = False
    Spec_relevant_params = {"qubit_gain": 100, "SpecSpan": 50, "SpecNumPoints": 71, 'Gauss': True, "sigma": 0.05,
                            "gain": 3000, 'reps': 25, 'rounds': 25}
    ...
    #                "relax_delay": 500}
    T1T2_params = {"T1_step": 1, "T1_expts": 200, "T1_reps": 25, "T1_rounds": 25,
                   "T2_step": 0.0048, "T2_expts": 400, "T2_reps":30, "T2_rounds": 30, "freq_shift": 0, "phase_step_deg": 10,
                   "relax_delay": 150}
    ...
    RunT1_TLS = True
    T1TLS_params = {'gainStart': -20000, 'gainStop': 20000, 'gainNumPoints': 4001, 'wait_times': [5, 12],
                    'angle': None, 'threshold': None,
                    'meas_shots': 200, 'repeated_nums': 10, 'SS_calib_shots': 3500,
                    'qubitIndex': SweepFF}

    SingleShot = False
    SS_params = {"Shots": 2000, "Readout_Time": 3, "ADC_Offset": 0.3, "Qubit_Pulse": Qubit_Pulse,
                 'number_of_pulses': 1, 'relax_delay': 150}
    # SS_params = {"Shots": 100000, "Readout_Time": 35, "ADC_Offset": 0.5, "Qubit_Pulse": Qubit_Pulse}

    SingleShot_ReadoutOptimize = False
    SS_R_params = {"gain_start": 2500, "gain_stop": 10000, "gain_pts": 7, "span": 3, "trans_pts": 9, 'number_of_pulses': 1}
    # SS_R_params = {"gain_start": 4000, "gain_stop": 6000, "gain_pts": 7, "span": 1, "trans_pts": 7}

    SingleShot_QubitOptimize = False
    SS_Q_params = {"Optimize_Index": 0, "q_gain_span": 500, "q_gain_pts": 7, "q_freq_span": 4, "q_freq_pts": 9,
                   'number_of_pulses': 1}
