...
Qubit_Parameters = {
    '1': {'Readout': {'Frequency': 7322 - mixer_freq - BaseConfig["cavity_LO"] / 1e6, 'Gain': 13000,
                      "FF_Gains": [0, 0, 0, 0], "Readout_Time": 2.5, "ADC_Offset": 0.3, 'cavmin': True},
          'Qubit': {'Frequency': 4646, 'Gain': 2790},
          'Pulse_FF': [0, 0, 0, 0]},
    '2': {'Readout': {'Frequency': 7269.6 - mixer_freq - BaseConfig["cavity_LO"] / 1e6, 'Gain': 8000,
                      "FF_Gains": [0, 0, 0, 0], "Readout_Time": 2.5, "ADC_Offset": 0.3, 'cavmin': True},
          'Qubit': {'Frequency': 4341.4, 'Gain': 15000},
          'Pulse_FF': [0, 0, 0, 0]},
...
#                "relax_delay": 500}
T1T2_params = {"T1_step": 1, "T1_expts": 150, "T1_reps": 15, "T1_rounds": 15,
               "T2_step": 0.0048, "T2_expts": 600, "T2_reps":20, "T2_rounds": 20, "freq_shift": 5.0, "angle_shift": 0,
               "relax_delay": 150}
...
SS_Q_params = {"Optimize_Index": 0, "q_gain_span": 2000, "q_gain_pts": 3, "q_freq_span": 5, "q_freq_pts": 11,
               'number_of_pulses': 1}
