...
from q4diamond.Client_modules.Experiment_Scripts.mSingleShotProgramFF import SingleShotProgram
...
#         }
#         self.gain_pts = np.linspace(expt_cfg["cav_Atten_Start"], expt_cfg["cav_Atten_Stop"], expt_cfg["cav_Atten_Points"])
...
#         for idx_atten in range(len(self.gain_pts)):
#             # start_2 = time.time()
#             ### set the cavity attenuation
#             cavityAtten.SetAttenuation(self.gain_pts[idx_atten])
#
