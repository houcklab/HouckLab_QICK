...
class LoopbackProgramSingleShotMIST(RAveragerProgram):
    ...
    def initialize(self):
        ...
        for ro_ch in cfg["ro_chs"]:
            ...
            #                      length=self.us2cycles(self.cfg["read_length"], gen_ch = cfg["res_ch"]), gen_ch=cfg["res_ch"])
            self.declare_readout(ch=ro_ch, freq=cfg["read_pulse_freq"],
...
class SingleShotMISTProgram(ExperimentClass):
    """
    ...
    def acquire(self, progress=False, debug=False):
        ...
        prog = LoopbackProgramSingleShotMIST(self.soccfg, self.cfg)
    ...
    def display(self, data=None, plotDisp = False, figNum = 1, save_fig = True, ran=None, **kwargs):
        ...
        title = ('Read Length: ' + str(self.cfg["read_length"]) + "us, freq: " + str(self.cfg["read_pulse_freq"])
                    ...
                    + '\n' + "Pop Length: " + str(self.cfg['pop_pulse_length']) + ' us, Gain: ' + str(self.cfg["pop_pulse_gain"])
                    + ", Depop Delay: " + str(self.cfg['depop_delay']) + ' us')
