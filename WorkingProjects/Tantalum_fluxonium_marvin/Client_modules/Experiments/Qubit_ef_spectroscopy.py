##### this experiment performs a loop over the normal amplitudeRabi, looking across a number of frequencies, after first doing a g-e pi pulse
...
from WorkingProjects.Tantalum_fluxonium_marvin.Client_modules.Experiments.mQubit_ef_spectroscopy import LoopbackProgramQubit_ef_spectroscopy
...
class Qubit_ef_spectroscopy(ExperimentClass):
    """
    Perform a g-e pi pulse, then pulse the qubit again with a swept frequency to find the e-f transition, all while
    sweeping gain, or something, this file doesn't currently work, I've screwed it up.
    """
    ...
    def acquire(self, progress=False, debug=False, plotDisp = True, figNum = 1):
        ...
        expt_cfg = {
            ### qubit freq parameters for the ef pulse
            ...
            ### ge pi pulse parameters
            "ge_freq": self.cfg["ge_freq"],
            "ge_gain": self.cfg["ge_gain"],
        }
