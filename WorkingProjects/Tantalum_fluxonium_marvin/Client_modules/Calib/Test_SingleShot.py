...
for idx in tqdm(range(loop_len)):
    ...
    Instance_SingleShotProgram = SingleShotProgram(path="dataTestSingleShotProgram_paramSweep_6p5",
...
UpdateConfig = {
    ...
    "read_pulse_style": "const", # --Fixed
    "read_length": 35, # us
    "read_pulse_gain": 2125, # [DAC units]
