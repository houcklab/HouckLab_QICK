...
import WorkingProjects.Tantalum_fluxonium_marvin.Client_modules.Helpers.LakeshoreChannel8Calib as lk8calib
import pyvisa

outerFolder = "Z:\\TantalumFluxonium\\Data\\2024_10_14_cooldown\\QCage_dev\\FridgeHeatingWithMagnet\\"
...
for i in range(ramp_up_vec.size):
    ...
    while error > tempr_stab:
        ...
        if itr > 1 :
            error = np.abs(qcage_tempr_list[-1] - qcage_tempr_list[-2])
