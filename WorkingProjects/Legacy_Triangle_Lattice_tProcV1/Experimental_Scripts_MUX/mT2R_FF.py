...
class T2R_FFProgram(AveragerProgramFF):
    ...
    def body(self):
        ...
        while remaining_length > 150:
            FF.FFPulses(self, self.FFPulse, 150)
            remaining_length -= 150
        FF.FFPulses(self, self.FFPulse, remaining_length)
        ...
        FF.FFPulses(self, self.FFReadouts, self.cfg['res_length'])
