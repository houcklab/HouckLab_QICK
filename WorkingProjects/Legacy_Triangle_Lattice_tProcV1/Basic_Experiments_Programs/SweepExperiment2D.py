...
from WorkingProjects.Triangle_Lattice_tProcV1.Helpers import SweepHelpers
from WorkingProjects.Triangle_Lattice_tProcV1.Helpers.RampHelpers import generate_ramp
from WorkingProjects.Triangle_Lattice_tProcV1.Helpers.IQ_contrast import *
...
import functools
import operator
import WorkingProjects.Triangle_Lattice_tProcV1.Helpers.SweepHelpers
                ...
                if isinstance(Instance, ExperimentClass):
                    ...
                    for ro_index in range(len(readout_list)):
                        ...
                        if self.cfg.get('confusion_matrix') is not None:
                            corrected_pop = correct_occ(excited_populations[ro_index], self.cfg['confusion_matrix'][ro_index])
                            self.data['data']['corrected_population'][ro_index][i,j] = corrected_pop
