...
# Expt_FF = FF_gains([-8975, -9545, -6552, -9022, -7816, -8227, -5634, -8534])
Expt_FF = FF_gains([-9287, -1027, -6639, -8835, -5989, -8153, -5482, -8560])
...
Qps.add_pulse('1R', resonance, 2719, 0.03, ff_array = Expt_FF.subsys(1, det=ramsey_detuning))
Qps.add_pulse('2R', resonance, 2540, 0.03, ff_array = Expt_FF.subsys(2, det=ramsey_detuning))
Qps.add_pulse('3R', resonance, 7414,0.03, ff_array = Expt_FF.subsys(3, det=ramsey_detuning))
Qps.add_pulse('4R', resonance, 3526, 0.03, ff_array = Expt_FF.subsys(4, det=ramsey_detuning))
Qps.add_pulse('5R', resonance, 4938, 0.03, ff_array = Expt_FF.subsys(5, det=ramsey_detuning))
Qps.add_pulse('6R', resonance, 3168, 0.03, ff_array = Expt_FF.subsys(6, det=ramsey_detuning))
Qps.add_pulse('7R', resonance, 3398, 0.03, ff_array = Expt_FF.subsys(7, det=ramsey_detuning))
Qps.add_pulse('8R', resonance, 3779, 0.03, ff_array = Expt_FF.subsys(8, det=ramsey_detuning))
...
Qps.add_pulse('1ef', resonance - 200, 2719/1.4, 0.03, ff_array = Expt_FF.subsys(1, det=ramsey_detuning))
Qps.add_pulse('2ef', resonance - 200, 2540/1.4, 0.03, ff_array = Expt_FF.subsys(2, det=ramsey_detuning))
Qps.add_pulse('3ef', resonance - 200, 7414/1.4,0.03, ff_array = Expt_FF.subsys(3, det=ramsey_detuning))
Qps.add_pulse('4ef', resonance - 200, 3526/1.4, 0.03, ff_array = Expt_FF.subsys(4, det=ramsey_detuning))
Qps.add_pulse('5ef', resonance - 200, 4938/1.4, 0.03, ff_array = Expt_FF.subsys(5, det=ramsey_detuning))
Qps.add_pulse('6ef', resonance - 200, 3168/1.4, 0.03, ff_array = Expt_FF.subsys(6, det=ramsey_detuning))
Qps.add_pulse('7ef', resonance - 200, 3398/1.4, 0.03, ff_array = Expt_FF.subsys(7, det=ramsey_detuning))
Qps.add_pulse('8ef', resonance - 200, 3779/1.4, 0.03, ff_array = Expt_FF.subsys(8, det=ramsey_detuning))
...
ramp_params = {
    ...
    '1234_correlations': {'BS': {'BS_FF': [-18559, -19389, 13852, 11589, -12362, -13234, 6521, 2252]},
                          't_offset': np.array([21, 23, 12, 23, 10, 12, 12, 4]),
                          'ij_samples': [0, 0, 0, 0, 0, 0, 0, 0],
                          'ij_gains': [None, None, None, None, None, None, None, None],
                          'pad_bs': [0, 0, 0, 0, 0, 0, 0, 0],
                          },
    ...
    '1245_correlations': {'BS': {'BS_FF': [22268, 21904, -25392, -2490, -1488, -28060, -25722, -24395]},
                          't_offset': np.array([21, 23, 12, 23, 10, 12, 12, 4]),
                          'ij_samples': [0, 0, 0, 0, 0, 0, 0, 0],
                          'ij_gains': [None, None, None, None, None, None, None, None],
                          'pad_bs': [0, 0, 0, 0, 0, 0, 0, 0],
    ...
    '4578_correlations': {'BS':{'BS_FF': [-26873, 7050, 7799, -6188, -5192, 8140, -13491, -16604]},
                          't_offset': np.array([21, 23, 12, 23, 10, 12, 12, 4]),
                          'ij_samples': [0, 0, 0, 0, 0, 0, 0, 0],
                          'ij_gains': [None, None, None, None, None, None, None, None],
                          'pad_bs': [0, 0, 0, 0, 0, 0, 0, 0],
