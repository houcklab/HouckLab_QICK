...
# manual
Expt_FF = np.array([-9260, -9812, -7228, -9688, -8477, -8969, -6010, -7071])
...
# Expt_FF = np.array([-9260, -9812, -7228, -9688, -8385, -8869, -6010, -7171])
...
Qubit_Parameters = {
    '1': {'Readout': {'Frequency': 7121.4, 'Gain': 800,
                      "FF_Gains": Readout_FF, "Readout_Time": 3, "ADC_Offset": 1, 'cavmin': True},
          'Qubit': {'Frequency': 3998.9, 'sigma': 0.07, 'Gain': 3600},
          'Pulse_FF': Readout_FF},
    '2': {'Readout': {'Frequency': 7077.3, 'Gain': 1000,
                      "FF_Gains": Readout_FF, "Readout_Time": 3, "ADC_Offset": 1, 'cavmin': True},
          'Qubit': {'Frequency': 3699.3, 'sigma': 0.07, 'Gain': 3300},
          'Pulse_FF': Readout_FF},
    '3': {'Readout': {'Frequency': 7511.33, 'Gain': 970,
                      "FF_Gains": Readout_FF, "Readout_Time": 3, "ADC_Offset": 1, 'cavmin': True},
          'Qubit': {'Frequency': 4361.9, 'sigma': 0.07, 'Gain': 4350},
          'Pulse_FF': Readout_FF},
    '4': {'Readout': {'Frequency': 7568.1, 'Gain': 1229,
                      "FF_Gains": Readout_FF, "Readout_Time": 3, "ADC_Offset": 1, 'cavmin': True},
          'Qubit': {'Frequency': 3948.9, 'sigma': 0.07, 'Gain': 2250},
          'Pulse_FF': Readout_FF + [0, 0, 0, 0, 0, 0, 0, 0]},
    '5': {'Readout': {'Frequency': 7362.65, 'Gain': 971,
                      'FF_Gains': Readout_FF, 'Readout_Time': 3, 'ADC_Offset': 1, 'cavmin': True},
          'Qubit': {'Frequency': 3612.0, 'sigma': 0.07, 'Gain': 2827},
          'Pulse_FF': Readout_FF },
    '6': {'Readout': {'Frequency': 7441.6, 'Gain': 1000,
                      'FF_Gains': Readout_FF, 'Readout_Time': 3, 'ADC_Offset': 1, 'cavmin': True},
          'Qubit': {'Frequency': 4308.4, 'sigma': 0.07, 'Gain': 2750},
          'Pulse_FF': Readout_FF},
    '7': {'Readout': {'Frequency': 7254.1, 'Gain': 1000,
                      'FF_Gains': Readout_FF, 'Readout_Time': 3, 'ADC_Offset': 1, 'cavmin': True},
          'Qubit': {'Frequency': 4052.17, 'sigma': 0.07, 'Gain': 3600},
          'Pulse_FF': Readout_FF},
    '8': {'Readout': {'Frequency': 7308.54, 'Gain': 1280,
                      'FF_Gains': Readout_FF, 'Readout_Time': 3, 'ADC_Offset': 1, 'cavmin': True},
          # 'Qubit': {'Frequency': 3537.05  + 40, 'sigma': 0.07, 'Gain': 3000},
          'Qubit': {'Frequency': 3601.7, 'sigma': 0.07, 'Gain': 2544},
    ...
    # far away
    '1_4815': {'Qubit': {'Frequency': 4099.5, 'sigma': 0.03, 'Gain': 7005},
                   'Pulse_FF': pulse_4815},
    '4_4815': {'Qubit': {'Frequency': 4203, 'sigma': 0.03, 'Gain': 6340},
                   'Pulse_FF': pulse_4815},
    '5_4815': {'Qubit': {'Frequency': 3802.8, 'sigma': 0.03, 'Gain': 8800},
                   'Pulse_FF': pulse_4815},
    '8_4815': {'Qubit': {'Frequency': 4125.6, 'sigma': 0.03, 'Gain': 6698},
                 'Pulse_FF': pulse_4815},
    ...
    '5_4815_readout': {'Readout': {'Frequency': 7363.37, 'Gain': 1229,
                                   'FF_Gains': pulse_4815, 'Readout_Time': 3, 'ADC_Offset': 1, 'cavmin': True},
                       'Qubit': {'Frequency': 3802.65, 'sigma': 0.07, 'Gain': 5300},
                       'Pulse_FF': pulse_4815},
    '8_4815_readout': {'Readout': {'Frequency': 7309.3, 'Gain': 1229,
                                   'FF_Gains': pulse_4815, 'Readout_Time': 3, 'ADC_Offset': 1, 'cavmin': True},
                       'Qubit': {'Frequency': 4125.54, 'sigma': 0.07, 'Gain': 3000},
                       'Pulse_FF': pulse_4815},
    ...
    '45': {'Ramp': {'Init_FF': Expt_FF + [8000, -8000, 8000, 0, Readout_FF[4], 8000, 8000, -8000],
    ...
    '1234_correlations': {'BS':{'BS_FF': [-18600, -19389, 13687, 11543, -11991, -13248, 4437, 2214]}},

    '1234_correlations_double': {'BS':{'BS_FF': [-18705, -19389, 13613, 11543, -12015, -13248, 4375, 2214]}},
