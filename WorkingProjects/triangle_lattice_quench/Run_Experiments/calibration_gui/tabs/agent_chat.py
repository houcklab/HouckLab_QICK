...
def _find_repo_root() -> Path:
    ...
    for parent in here.parents:
        if (parent / "CLAUDE.md").exists():
            return parent
    # Fallback to the repo root (HouckLab_QICK). This module now lives at
    # Run_Experiments/calibration_gui/tabs/, so the repo root is parents[5]:
    # tabs -> calibration_gui -> Run_Experiments -> triangle_lattice_quench
    # -> WorkingProjects -> HouckLab_QICK.
