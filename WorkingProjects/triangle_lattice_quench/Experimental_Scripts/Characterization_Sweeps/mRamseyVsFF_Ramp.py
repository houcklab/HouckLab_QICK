...
class RamseyVsFF_Ramp(RamseyVsFF):
    ...
    def init_sweep_vars(self):
        ...
        for Qubit, FFP, FFI in zip(('1', '2', '3', '4', '5', '6', '7', '8'), self.cfg["FFPrev"], self.cfg["FFInit"]):
            self.cfg["FF_Qubits"][Qubit] |= {'RamseyVsRamp': FFP, 'RamseyVsRamp_Init': FFI}

    def set_up_instance(self):

        self.cfg["IDataArray"] = FFEnvelope_Helpers.CompensatedRampArrays(self.cfg, 'RamseyVsRamp_Prev', 'RamseyVsRamp_Init',
                                                                          'Gain_Pulse',
