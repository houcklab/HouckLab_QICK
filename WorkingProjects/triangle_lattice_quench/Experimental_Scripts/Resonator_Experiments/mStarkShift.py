...
from WorkingProjects.Inductive_Coupler.Client_modules.Experimental_Scripts_MUX.mSpecSliceFFMUX import QubitSpecSliceFFProg
...
class StarkShift(ExperimentClass):
    ...
    def acquire(self, progress=False, debug=False, plotDisp = True, plotSave = True, figNum = 1):
        ...
        for i in range(expt_cfg["trans_gain_num"]):
            self.cfg["pulse_gains"] = [gainVec[i]]
