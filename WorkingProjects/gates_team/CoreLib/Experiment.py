...
class ExperimentClass:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        DataSubFolderBool = Path(
            os.path.join(self.outerFolder + self.path, self.path + "_" + datestring)
        ).is_dir()
