...
# from WorkingProjects.Triangle_Lattice.Experimental_Scripts_MUX.mT2R_TwoPulses import T2R_2PulseMUX, T2R_2PulseMUX_NoUpdate
...
Qubit_Parameters = {
    '1': {'Readout': {'Frequency': 6978.5 - mixer_freq - BaseConfig["cavity_LO"] / 1e6, 'Gain': 15000,
          ...
          'Pulse_FF': [-30000, 0, 0, 0]},  #second index' for currents
...
Run2ToneSpec = False
Spec_relevant_params = {"qubit_gain": 2000, "SpecSpan":30, "SpecNumPoints": 71, 'Gauss': False, "sigma": 0.05,
                        "gain": 950, 'reps': 12, 'rounds': 12}

Run_Spec_v_FFgain = True
### Inherits spec parameters from above
FF_sweep_spec_relevant_params = {"qubit_FF_index": 1,
                            "FF_gain_start": -30000, "FF_gain_stop":30000, "FF_gain_steps":25}
...
if RunTransmissionSweep:
    ...
    print('freqs before: ', config["res_freqs"])
    ...
    if Qubit_Parameters[str(Qubit_Readout[0])]['Readout']['cavmin']:
        ...
        config["res_freqs"][0] += Instance_trans.peakFreq_max - mixer_freq + 0.3
        config["mixer_freq"] = Instance_trans.peakFreq_max

    print('min freq; ', Instance_trans.peakFreq_min)
    print('freqs after: ', config["res_freqs"])
