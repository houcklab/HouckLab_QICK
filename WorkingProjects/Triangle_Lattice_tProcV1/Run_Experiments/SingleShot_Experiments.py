...
from WorkingProjects.Triangle_Lattice_tProcV1.Experimental_Scripts_MUX.mGainSweepQubitOscillationsR import GainSweepOscillationsR
from WorkingProjects.Triangle_Lattice_tProcV1.Experimental_Scripts_MUX.mSpecVsQblox import SpecVsQblox
from WorkingProjects.Triangle_Lattice_tProcV1.Experimental_Scripts_MUX.mT2R_FF import T2RFF
from WorkingProjects.Triangle_Lattice_tProcV1.Experimental_Scripts_MUX.mTime_domain_spectroscopy import TimeDomainSpec
...
Qubit_Parameters = {
    '1': {'Readout': {'Frequency': 6978.79 - mixer_freq - BaseConfig["cavity_LO"] / 1e6, 'Gain': 10900,
          ...
          'Pulse_FF': [0, 0, 0, -30000]},  # FOURTH index
...
Qubit_Parameters = {
    '1': {'Readout': {'Frequency': 6978.778 - mixer_freq - BaseConfig["cavity_LO"] / 1e6, 'Gain': 12000,
                      "FF_Gains": [0, 0, 30000, -30000], "Readout_Time": 2.5, "ADC_Offset": 0.3, 'cavmin': True},
          'Qubit': {'Frequency': 4279.65, 'sigma': 0.05, 'Gain': 28000},
...
FF_sweep_spec_relevant_params = {"qubit_FF_index": 3,
                            "FF_gain_start": 0, "FF_gain_stop":20000, "FF_gain_steps":7}
...
T2FF = True # Runs one or the other
