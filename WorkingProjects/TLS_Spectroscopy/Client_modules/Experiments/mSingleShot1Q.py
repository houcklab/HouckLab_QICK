    ...
    def body(self):
        ...
        if feedback:
            ...
            reset_pi_freq = (
                ...
                cfg["qubit_freq"])
            self.mathi(page, 3, self.r_gain, "+", 0)
            self.mathi(page, 4, self.r_gain2, "+", 0)
            ...
            self.mathi(page, self.r_gain, 3, "+", 0)
            self.mathi(page, self.r_gain2, 4, "+", 0)
