...
from WorkingProjects.QM_Team.qubit_measurements.Client_modules.Experimental_Scripts_MUX.mSingleShotProgramFFMUX import SingleShotProgram

from WorkingProjects.QM_Team.qubit_measurements.Client_modules.Experiment import ExperimentClass
