...
Qubit_Parameters = {
    "1": {
        "Readout": {"Frequency": 6500.039, "Gain": int(5000)},
        "Qubit": {
            "Frequency": 1833.46,
            "Gain": int(9000),
            "sigma": 0.1,
    ...
    "2": {
        "Readout": {"Frequency": 6631.07, "Gain": 2300},
        "Qubit": {
            "Frequency": 3197.65,
            "Gain": 6330,
            "sigma": 0.3,
    ...
    "3": {
        "Readout": {"Frequency": 6766.67, "Gain": 1800},
        "Qubit": {
            "Frequency": 3523.9,
            "Gain": 5690,
            "sigma": 0.3,
    ...
    "4": {
        "Readout": {"Frequency": 6787.378, "Gain": 5000},
        "Qubit": {
            "Frequency": 2225.5,
            "Gain": 10000,
            "sigma": 0.01,
    ...
    "5": {
        "Readout": {"Frequency": 7019.20, "Gain": 1000},
        "Qubit": {
            "Frequency": 3893.51,
            "Gain": 5500,
            "sigma": 0.03,
    ...
    "6": {
        "Readout": {"Frequency": 7077.98, "Gain": 1500},
        "Qubit": {
            "Frequency": 4025.84,
            "Gain": 7300,
            "sigma": 0.03,
...
T2E_params = {
    ...
    "freq_shift": 0.08,
    "relax_delay": 4000,
    "num_pi_pulses": 0,  # need odd number of pulses
    "pi2_gain": 2580,
...
T1SS_params = {
    ...
    "T1_expts": 40,
    "reps": 1000,
    "angle": 0.38920197938248996,
    "threshold": 1.6117224595654793,
    "relax_delay": 5000,
    "calibrate_SS": True,
    "repetitions": 120,
}
