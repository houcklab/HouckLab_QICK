...
Qubit_Parameters = {
    '1': {'Readout': {'Frequency': 6590.80, 'Gain': 625},
          'Qubit': {'Frequency': 2353.43, 'Gain': 5400, "sigma": 0.1, "flattop_length": 0.2},    #pi: 7400, pi/2: 3700
          'outerfoldername': "Z:/t1Team/Data/2025-04-12_cooldown/TATQ02-CL-01/RFSOC/T1/"},
    ...
    '3': {'Readout': {'Frequency': 6785.03, 'Gain': 800},
          'Qubit': {'Frequency': 2709.16, 'Gain': 4700, "sigma": 0.1, "flattop_length": 0.1},    #pi: 5000, pi/2: 2500
          'outerfoldername': "Z:/t1Team/Data/2025-04-12_cooldown/TATQ02-CL-01/RFSOC/T1/"},
    '4': {'Readout': {'Frequency': 6903.65, 'Gain': 850},
          'Qubit': {'Frequency': 2746.5, 'Gain': 6000, "sigma": 0.1, "flattop_length": 0.4},    #pi: 5300, pi/2: 2650
          'outerfoldername': "Z:/t1Team/Data/2025-04-12_cooldown/TATQ02-CL-01/RFSOC/T1/"},
    '5': {'Readout': {'Frequency': 7025.2, 'Gain': 1700},
          'Qubit': {'Frequency': 3402.45, 'Gain': 4850, "sigma": 0.2, "flattop_length": 0.6},     # pi: 5000, pi/2: 1850
          'outerfoldername': "Z:/t1Team/Data/2025-04-12_cooldown/TATQ02-CL-01/RFSOC/T1/"},
    '6': {'Readout': {'Frequency': 7153.08, 'Gain': 1250},
          'Qubit': {'Frequency': 3294.1, 'Gain': 4780, "sigma": 0.05, "flattop_length": 0.1},    # pi: 6500, pi/2: 3250
          'outerfoldername': "Z:/t1Team/Data/2025-04-12_cooldown/TATQ02-CL-01/RFSOC/T1/"}
    }

T1_qubitsweep = True
T1T2_params = {"qubit_swept": [1, 3, 4, 5, 6],
               "T1_step_list": [30, 1, 40, 20, 40, 20],
               "T1_expts_list": [100, 1, 100, 100, 100, 100],
               "T1_reps_list": [20, 1, 20, 20, 20, 20],
               "T1_rounds_list": [20, 1, 520, 20, 20, 20],
               "relax_delay": 4000}
