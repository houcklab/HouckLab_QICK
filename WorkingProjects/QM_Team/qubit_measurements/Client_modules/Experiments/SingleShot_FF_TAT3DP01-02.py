...
#           'Qubit': {'Frequency': 3355.42, 'Gain': 2750, "sigma": 0.15, "flattop_length": None},  # pi: 2750, pi/2: 1375
#           'outerfoldername': "Z:/t1Team/Data/2026-04-01_BFF_cooldown/TAT3DP01-02/RFSOC/Q1/"},  # readout_time: 15
#
#     '4': {'Readout': {'Frequency': 7386.94, 'Gain': 4700},
#           'Qubit': {'Frequency': 2857.46, 'Gain': 2000, "sigma": 0.2, "flattop_length": None},  # pi: 2000, pi/2: 1000
#           'outerfoldername': "Z:/t1Team/Data/2026-04-01_BFF_cooldown/TAT3DP01-02/RFSOC/Q4/"}  # readout_time: 15
# }

Qubit_Parameters = {
    '1': {'Readout': {'Frequency': 6607.5, 'Gain': 5000},
          'Qubit': {'Frequency': 2131, 'Gain': 5000, "sigma": 1, "flattop_length": 5},
          'outerfoldername': "Z:t1Team/Data/2026-04-01_BFF_cooldown/TATQ01-3minHF-10secKOH-03/RFSoC/Q1/"},

    '2': {'Readout': {'Frequency': 6689.14, 'Gain': 4000},
          'Qubit': {'Frequency': 2392.2, 'Gain': 7000, "sigma": 1.8, "flattop_length": None},
          'outerfoldername': "Z:t1Team/Data/2026-04-01_BFF_cooldown/TATQ01-3minHF-10secKOH-03/RFSoC/Q2/"},

    '3': {'Readout': {'Frequency': 6809.31, 'Gain': 3000},
          'Qubit': {'Frequency': 2463, 'Gain': 6000, "sigma": 1, "flattop_length": 2},
          'outerfoldername': "Z:t1Team/Data/2026-04-01_BFF_cooldown/TATQ01-3minHF-10secKOH-03/RFSoC/Q3/"},

    '4': {'Readout': {'Frequency': 6893.27, 'Gain': 6000},
          'Qubit': {'Frequency': 2441.24, 'Gain': 5270, "sigma": 0.5, "flattop_length": 2},  #pi = 2200
          'outerfoldername': "Z:t1Team/Data/2026-04-01_BFF_cooldown/TATQ01-3minHF-10secKOH-03/RFSoC/Q4/"},

    '5': {'Readout': {'Frequency': 7007.0, 'Gain': 6000},
          'Qubit': {'Frequency': 2785.1, 'Gain': 7400, "sigma": 1.2, "flattop_length": None},
    ...
    '6': {'Readout': {'Frequency': 7073.33, 'Gain': 5000},
          'Qubit': {'Frequency': 2919.72, 'Gain': 5600, "sigma": 0.9, "flattop_length": None}, #5600
          'outerfoldername': "Z:t1Team/Data/2026-04-01_BFF_cooldown/TATQ01-3minHF-10secKOH-03/RFSoC/Q6/T2ESS"}
}
...
#           'Qubit': {'Frequency': 2122.5, 'Gain': 2450, "sigma": 1.5, "flattop_length": None}, # pi: 6000, pi/2: ,
...
#           'Qubit': {'Frequency': 2520.16, 'Gain': 4550, "sigma": 0.5, "flattop_length": None},  # pi: 4550, pi/2: 1425,
#           'outerfoldername': "Z:/t1Team/Data/2026-04-01_BFF_cooldown/TATQ01-3minHF-10secKOH-04/RFSoC/Q5/"},  # readout_time:
...
Run2ToneSpec = False
Spec_relevant_params = {"qubit_gain": 8000, "SpecSpan": 2, "SpecNumPoints": 101,
                        "reps": 10, 'rounds': 10,
                        'Gauss': False, "sigma": 1.8, "gain": 8000} # False -- no pulse #If you don't see RabiAmp but with Gauss True see the qubit, the next thing to check is gain, you might not have the right pi pulse

RunChiShift = False
ChiShift_params = {"reps": 20,
...
RunT1 = True
RunT2 = False
T1T2_params = {"T1_step": 60, "T1_expts": 100, "T1_reps": 20, "T1_rounds": 20,
               "T2_step": 50, "T2_expts": 50, "T2_reps": 15, "T2_rounds": 15, "freq_shift": 0.0,
               "relax_delay": 5000,
               'repetitions': 5000}

RunT2E = False
T2E_params = {"T2_max_us": 300, "T2_expts": 40, "T2_reps": 20, "T2_rounds": 20, "freq_shift": 0.1,
...
SS_R_params = {"gain_start": 3000, "gain_stop": 6000, "gain_pts": 5, "span": 0.7, "trans_pts": 5}

SingleShot_QubitOptimize = False #gain_span is now in percent
SS_Q_params = {"q_gain_span": 0.1, "q_gain_pts": 7, "q_freq_span": 0.5, "q_freq_pts": 5,
...
if RunT2E:
    ...
    T2E_cfg = {"start": 0, "step": 0.00232515 * (num_pulses + 1) * int_steps,
               ...
               "sigma": qubit_sigma, "flattop_length": qubit_flattop, "Qubit_number": Qubit_Readout
               }
