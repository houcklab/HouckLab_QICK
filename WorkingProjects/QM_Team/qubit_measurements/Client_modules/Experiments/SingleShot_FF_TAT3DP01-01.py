...
Qubit_Parameters = {
    '1': {'Readout': {'Frequency': 6803.5, 'Gain': 4000},
          'Qubit': {'Frequency': 2875.68, 'Gain': 950, "sigma": 0.08, "flattop_length": None},  # pi: 1900, pi/2: 950,
          'outerfoldername': "Z:/t1Team/Data/2026-04-01_BFF_cooldown/TAT3DP01-01/RFSOC/Q1/"},  # readout_time:

    '2': {'Readout': {'Frequency': 6984.54, 'Gain': 3500},
          'Qubit': {'Frequency': 2616.7, 'Gain': 2450, "sigma": 0.05, "flattop_length": None}, # pi: 6000, pi/2: ,
          'outerfoldername': "Z:/t1Team/Data/2026-04-01_BFF_cooldown/TAT3DP01-01/RFSOC/Q2/"},  # readout_time:

    '4': {'Readout': {'Frequency': 7372.65, 'Gain': 5500},
          'Qubit': {'Frequency': 2376.82, 'Gain': 2850, "sigma": 0.1, "flattop_length": None},  # pi: 2850, pi/2: 1425,
          'outerfoldername': "Z:/t1Team/Data/2026-04-01_BFF_cooldown/TAT3DP01-01/RFSOC/Q4/"}  # readout_time:
}
...
#           'Qubit': {'Frequency': 2520.16, 'Gain': 2150, "sigma": 0.5, "flattop_length": None},  # pi: 4550, pi/2: 1425,
...
Run2ToneSpec = False
Spec_relevant_params = {"qubit_gain": 10000, "SpecSpan": 50, "SpecNumPoints": 101,
                        "reps": 10, 'rounds': 10,
                        'Gauss': False, "sigma": 1.8, "gain": 10000} # False -- no pulse #If you don't see RabiAmp but with Gauss True see the qubit, the next thing to check is gain, you might not have the right pi pulse
...
Amplitude_Rabi_params = {"qubit_freq": Qubit_Parameters[str(Qubit_Pulse)]['Qubit']['Frequency'],
                         ...
                         "reps": 15, 'rounds': 15,
                         'relax_delay': 7000}  #Always change the max gain if you don't see it, also compare what you get with Transmission data

RunT1 = False
RunT2 = False
T1T2_params = {"T1_step": 50, "T1_expts": 100, "T1_reps": 15, "T1_rounds": 15,
               "T2_step": 20, "T2_expts": 50, "T2_reps": 5, "T2_rounds": 50, "freq_shift": 0.2,
               "relax_delay": 5000,
               'repetitions': 1000}

RunT2E = False
T2E_params = {"T2_max_us": 2000, "T2_expts": 100, "T2_reps": 10, "T2_rounds": 10, "freq_shift": 0.0,
...
SingleShot = False
SS_params = {"Shots": 2000, "Readout_Time": 15, "ADC_Offset": 0.5, "Qubit_Pulse": [Qubit_Pulse],
             'number_of_pulses': 2, 'relax_delay': 7000}
...
SS_R_params = {"gain_start": 1000, "gain_stop": 4000, "gain_pts": 7, "span": 1, "trans_pts": 7}

SingleShot_QubitOptimize = False #gain_span is now in percent
SS_Q_params = {"q_gain_span": 0.1, "q_gain_pts": 7, "q_freq_span": 1, "q_freq_pts": 7,
