...
############## Start Can D ############################
# Qubit_Parameters = {
#     '1': {'Readout': {'Frequency': 6723.774, 'Gain': int(4000)},
#           'Qubit': {'Frequency': 848.3, 'Gain': int(5000), "sigma": 0.03, "flattop_length": 0.8},
#           'Pulse_FF': [0, 0, 0, 0],
#           'outerfoldername':"Z:/t1Team/Data/2025-11-04_BFF_cooldown/2025-11-10_TATQ03/RFSOC/Q1//"},
#     '2': {'Readout': {'Frequency': 6834.436, 'Gain': 4000},
#           'Qubit': {'Frequency': 1057, 'Gain': 5000, "sigma": 0.2, "flattop_length": 0.8}, #0.03 sigma
#           'Pulse_FF': [0, 0, 0, 0],
#           'outerfoldername':"Z:/t1Team/Data/2025-11-04_BFF_cooldown/2025-11-10_TATQ03/RFSOC/Q2//"},
#     '3': {'Readout': {'Frequency': 6929.038, 'Gain': 4000},
#           'Qubit': {'Frequency': 1201, 'Gain': 5000, "sigma": 0.2, "flattop_length": 0.8},
#           'Pulse_FF': [0, 0, 0, 0],
#           'outerfoldername': "Z:/t1Team/Data/2025-11-04_BFF_cooldown/2025-11-10_TATQ03/RFSOC/Q3//"},
#     '4': {'Readout': {'Frequency': 7014.036, 'Gain': 3000},
#           'Qubit': {'Frequency': 1278, 'Gain': 8000, "sigma": 0.4, "flattop_length": 20},
#           'Pulse_FF': [0, 0, 0, 0],
...
Qubit_Parameters = {
    '1': {'Readout': {'Frequency': 6723.774, 'Gain': int(4000)},
          'Qubit': {'Frequency': 848.3, 'Gain': int(5000), "sigma": 0.03, "flattop_length": 0.8},
          'outerfoldername': "Z:/t1Team/Data/2026-01-15_BFF_cooldown/TATQ01-20sKOH-3minHF-16hr250C/RFSOC/Q1/"},

    '2': {'Readout': {'Frequency': 6834.436, 'Gain': 4000},
          'Qubit': {'Frequency': 1057, 'Gain': 5000, "sigma": 0.2, "flattop_length": 0.8},
          'outerfoldername': "Z:/t1Team/Data/2026-01-15_BFF_cooldown/TATQ01-20sKOH-3minHF-16hr250C/RFSOC/Q2/"},

    '3': {'Readout': {'Frequency': 6942.83, 'Gain': int(5000)},
          'Qubit': {'Frequency': 2635.78, 'Gain': int(5000), "sigma": 0.5, "flattop_length": 5},
          'outerfoldername': "Z:/t1Team/Data/2026-01-15_BFF_cooldown/TATQ01-20sKOH-3minHF-16hr250C/RFSOC/Q3/"},

    '4': {'Readout': {'Frequency': 7030.4, 'Gain': 6500},
          'Qubit': {'Frequency': 2885.25, 'Gain': 1775, "sigma": 0.08, "flattop_length": None},
          'outerfoldername': "Z:/t1Team/Data/2026-01-15_BFF_cooldown/TATQ01-20sKOH-3minHF-16hr250C/RFSOC/Q4/"},

    '5': {'Readout': {'Frequency': 7141.868, 'Gain': 11000},
          'Qubit': {'Frequency': 2920.70, 'Gain': 4500, "sigma": 0.6, "flattop_length": None},
          'outerfoldername': "Z:/t1Team/Data/2026-01-15_BFF_cooldown/TATQ01-20sKOH-3minHF-16hr250C/RFSOC/Q5/"},

    '6': {'Readout': {'Frequency': 7229.826, 'Gain': 5000},
          'Qubit': {'Frequency': 3001.76, 'Gain': 8000, "sigma": 0.6, "flattop_length": 20},
          'outerfoldername': "Z:/t1Team/Data/2026-01-15_BFF_cooldown/TATQ01-20sKOH-3minHF-16hr250C/RFSOC/Q6/"},
    }
...
Run2ToneSpec = False
Spec_relevant_params = {"qubit_gain": 6000, "SpecSpan": 2.55, "SpecNumPoints": 101,
                        "reps": 10, 'rounds': 10,
                        'Gauss': True, "sigma": 0.4, "gain": 6000} # False -- no pulse #If you don't see RabiAmp but with Gauss True see the qubit, the next thing to check is gain, you might not have the right pi pulse
...
RunT1 = True
RunT2 = False
T1T2_params = {"T1_step": 10, "T1_expts": 100, "T1_reps": 10, "T1_rounds": 10,
...
SingleShot = False
SS_params = {"Shots": 1000, "Readout_Time": 20, "ADC_Offset": 0.5, "Qubit_Pulse": [Qubit_Pulse],
             'number_of_pulses': 1, 'relax_delay': 1000}

RunT1SS = False
T1SS_params = {"T1_step": 30, "T1_expts": 100,
               "reps": 100,
...
SS_R_params = {"gain_start": 7000, "gain_stop": 12000, "gain_pts": 7, "span": 1, "trans_pts": 7}

SingleShot_QubitOptimize = False  #gain_span is now in percent
SS_Q_params = {"q_gain_span": 0.25, "q_gain_pts": 7, "q_freq_span": 0.75, "q_freq_pts": 7,
