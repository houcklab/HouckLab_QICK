...
import time
from WorkingProjects.QM_Team.qubit_measurements.Client_modules.Experiments.mTransmissionFF import (
    CavitySpecFF,
)
from WorkingProjects.QM_Team.qubit_measurements.Client_modules.Experiments.mSingleTone import (
    SingleTone,
)

from WorkingProjects.QM_Team.qubit_measurements.Client_modules.Experiments.mSpecSliceFF import (
    QubitSpecSliceFF,
)
from WorkingProjects.QM_Team.qubit_measurements.Client_modules.Experiments.mAmplitudeRabiFF import (
    AmplitudeRabiFF,
)
from WorkingProjects.QM_Team.qubit_measurements.Client_modules.Experiments.mAmplitudeRabiFF_noUpdate import (
    AmplitudeRabiFF_N,
)
from WorkingProjects.QM_Team.qubit_measurements.Client_modules.Experiments.mChiShift import (
    ChiShift,
)

from WorkingProjects.QM_Team.qubit_measurements.Client_modules.Experiments.mT1FF import (
    T1FF,
)
from WorkingProjects.QM_Team.qubit_measurements.Client_modules.Experiments.mT2R import (
    T2R,
)
from WorkingProjects.QM_Team.qubit_measurements.Client_modules.Experiments.mT2EFF import (
    T2EMUX,
)
...
from WorkingProjects.QM_Team.qubit_measurements.Client_modules.Experiments.mT1_SS import (
    T1_SS,
)
from WorkingProjects.QM_Team.qubit_measurements.Client_modules.Experiments.mOptimizeReadoutandPulse_FF import (
...
Qubit_Parameters = {
    "1": {
        "Readout": {"Frequency": 7537.55, "Gain": 2800},
        "Qubit": {
            "Frequency": 4751.9,
            "Gain": 3050,
            "sigma": 0.05,
        ...
        "outerfoldername": "Z:\FluxTeam\Data\rfsoc_test",
    },
    "2": {
        "Readout": {"Frequency": 7751.9, "Gain": 5000},
        "Qubit": {
            "Frequency": 4622.25,
            "Gain": 1025,
            "sigma": 0.05,
        ...
        "outerfoldername": "Z:/t1Team/Data/2025-03-06_BFD_cooldown/TATQ01-KI-02/RFSoC/Q2/",
    },
    "3": {
        "Readout": {"Frequency": 7921.334, "Gain": 500},
        "Qubit": {
            "Frequency": 5616.39,
            "Gain": 2500,
            "sigma": 0.05,
        ...
        "outerfoldername": "Z:/t1Team/Data/2025-03-06_BFD_cooldown/TATQ01-KI-02/RFSoC/Q3/",
    },
    "4": {
        "Readout": {"Frequency": 7988.6, "Gain": 3750},
        "Qubit": {
            "Frequency": 4653.5,
            "Gain": 260,
            "sigma": 0.05,
        ...
        "outerfoldername": "Z:/t1Team/Data/2025-03-06_BFD_cooldown/TATQ01-KI-02/RFSoC/Q4/",
    },
    "5": {
        "Readout": {"Frequency": 8235.6, "Gain": 6000},
        "Qubit": {
            "Frequency": 5126.128,
            "Gain": 1820,
            "sigma": 0.05,
        ...
        "outerfoldername": "Z:/t1Team/Data/2025-03-06_BFD_cooldown/TATQ01-KI-02/RFSoC/Q5/",
    },
    "6": {
        "Readout": {"Frequency": 8356.3, "Gain": 6000},
        "Qubit": {
            "Frequency": 5264.446,
            "Gain": 2680,
            "sigma": 0.05,
        ...
        "outerfoldername": "Z:/t1Team/Data/2025-03-06_BFD_cooldown/TATQ01-KI-02/RFSoC/Q6/",
    },
}
...
T1SS_params = {
    ...
    "T1_expts": 100,
    "reps": 100,
    "angle": -1.2554343542620698,
    "threshold": -3.1841847292341834,
    "relax_delay": 5000,
    "calibrate_SS": True,
    "repetitions": 1,
}
...
if Run2ToneSpec:
    ...
    QubitSpecSliceFF.display(
        Instance_specSlice, data_specSlice, plotDisp=True, figNum=2
    )
...
if RunT2E:
    ...
    if int_steps == 0:
        ...
        iT2E = T2EMUX(
            path="T2E", cfg=config, soc=soc, soccfg=soccfg, outerFolder=outerFolder
        )
...
if SingleShot_QubitOptimize:
    ...
    exp_parameters = {
        ...
        "qubit_gain_Start": max(
            [0, int(qubit_gains[Qubit_Pulse_Index] * (1 - q_gain_span))]
        ),  # - q_gain_span / 2,
        "qubit_gain_Stop": min(
            [32767, int(qubit_gains[Qubit_Pulse_Index] * (1 + q_gain_span))]
        ),  # *qubit_gains[Qubit_Pulse_Index] + q_gain_span / 2,
        "qubit_gain_Points": q_gain_pts,
        "qubit_freq_start": qubit_frequency_centers[Qubit_Pulse_Index]
        - q_freq_span / 2,  # 249.6,
        "qubit_freq_stop": qubit_frequency_centers[Qubit_Pulse_Index]
        + q_freq_span / 2,  # 250.3,
