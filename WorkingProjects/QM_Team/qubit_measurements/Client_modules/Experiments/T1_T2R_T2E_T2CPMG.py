...
# Readout
Qubit_Readouts = [1, 2, 4, 5, 6]
Qubit_Pulses = [1, 2, 4, 5, 6]
pi2_gains = [2100, 2330, 1100, 2900, 2490]

t1_steps = [20, 20, 20, 20, 20]
t1_expts = [150, 150, 150, 150, 150]

t2_steps = [5, 5, 5, 5, 5]
t2_expts = [200, 300, 60, 200, 100]

t2e_maxs = [3000, 3000, 3000, 3000, 3000]
t2e_expts = [150, 150, 150, 150, 150]
...
while True:
    for idx, Qubit_Readout in enumerate(Qubit_Readouts):
        ...
        RunT1 = True
        RunT2 = False
        T1T2_params = {"T1_step": t1_step, "T1_expts": t1_expt, "T1_reps": 12, "T1_rounds": 12,
