...
while True:
    for idx, Qubit_Readout in enumerate(Qubit_Readouts):
        ...
        RunT1 = False
        RunT2 = False
        T1T2_params = {"T1_step": t1_step, "T1_expts": t1_expt, "T1_reps": 15, "T1_rounds": 15,
                       "T2_step": t2_step, "T2_expts": t2_expt, "T2_reps": 15, "T2_rounds": 15, "freq_shift": 0.0,
                       "relax_delay": 6000,"sigma": 0.03,
                       'repetitions': 1}

        RunT2E = True
        T2E_params = {"T2_max_us": t2e_max, "T2_expts": t2e_expt, "T2_reps": 15, "T2_rounds": 15, "freq_shift": 0.1,
                       "relax_delay": 1000,
                       "pi2_gain": pi2_gain_,
                      'repetitions': 1000,
                      "num_pulses": [1],
