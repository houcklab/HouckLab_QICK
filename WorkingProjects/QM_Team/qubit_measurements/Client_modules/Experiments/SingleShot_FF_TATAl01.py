...
############### Start Can D ############################
Qubit_Parameters = {
    '1': {'Readout': {'Frequency': 6600.59, 'Gain': 3000},
          'Qubit': {'Frequency': 3066.82, 'Gain': 3950, "sigma": 0.1, "flattop_length": 4},
          'Pulse_FF': [0, 0, 0, 0],
          'outerfoldername':"Z:/t1Team/Data/2024-11-04_CoolDown/TATQ02-Si-01/Q1_6p60/"},
    '3': {'Readout': {'Frequency': 6916.25, 'Gain': 4000},
          'Qubit': {'Frequency': 3433.023, 'Gain': 6200, "sigma": 0.1, "flattop_length": 8},
          'Pulse_FF': [0, 0, 0, 0],
          'outerfoldername': "Z:/t1Team/Data/2024-10-16_cooldown/TATAl01-03/Q3_6p92//"},
    '5': {'Readout': {'Frequency': 7122.05, 'Gain': 3000},
          'Qubit': {'Frequency': 4119.54, 'Gain': 4760, "sigma": 0.05, "flattop_length": 2},
          'Pulse_FF': [0, 0, 0, 0],
          'outerfoldername': "Z:/t1Team/Data/2024-10-16_cooldown/TATAl01-03/Q5_7p12//"},
    '6': {'Readout': {'Frequency': 7198.94, 'Gain': 3000},
          'Qubit': {'Frequency': 4576.77, 'Gain': 4450, "sigma": 0.01, "flattop_length": 1},
          'Pulse_FF': [0, 0, 0, 0],
          'outerfoldername': "Z:/t1Team/Data/2024-10-16_cooldown/TATAl01-03/Q6_7p20//"},
    }
# ############### End Can D ############################
...
Run2ToneSpec = False
Spec_relevant_params = {"qubit_gain": 6000, "SpecSpan": 5, "SpecNumPoints": 101,
                        "reps": 10, 'rounds': 20,
                        'Gauss': False, "sigma": 2, "gain": 2000} # False -- no pulse #If you don't see RabiAmp but with Gauss True see the qubit, the next thing to check is gain, you might not have the right pi pulse
...
#                "relax_delay": 2000}
RunT2E = False
T2E_params = {"T2_max_us": 5000, "T2_expts": 100, "T2_reps": 1, "T2_rounds": 200, "freq_shift": 0.0,
...
SS_R_params = {"gain_start": 2000, "gain_stop": 4000, "gain_pts": 11, "span": 0.5, "trans_pts": 7}

SingleShot_QubitOptimize = False
#gain_span is now in percent
SS_Q_params = {"q_gain_span": 0.01, "q_gain_pts": 11, "q_freq_span": 0.01, "q_freq_pts": 11,
