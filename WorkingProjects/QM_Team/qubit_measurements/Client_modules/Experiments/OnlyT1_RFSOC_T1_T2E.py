...
Qubit_Parameters = {
    "1": {
        ...
        "outerfoldernameT1": "Z:/t1Team/Data/2025-03-06_BFD_cooldown/TATQ01-KI-02/RFSoC/Q1/T1Sweep",
        "outerfoldernameT2": "Z:/t1Team/Data/2025-03-06_BFD_cooldown/TATQ01-KI-02/RFSoC/Q1/T2Sweep",
    },
    "2": {
        ...
        "outerfoldernameT1": "Z:/t1Team/Data/2025-03-06_BFD_cooldown/TATQ01-KI-02/RFSoC/Q2/T1Sweep",
        "outerfoldernameT2": "Z:/t1Team/Data/2025-03-06_BFD_cooldown/TATQ01-KI-02/RFSoC/Q2/T2Sweep",
    },
    "3": {
        "Readout": {"Frequency": 6980.928, "Gain": 2100},
        "Qubit": {
            "Frequency": 5239.945,
            "Gain": 7500,
            "sigma": 0.05,
        ...
        "outerfoldernameT1": "Z:/t1Team/Data/2026-01-21_BFD_cooldown/DynOxd_Si/RFSOC/Q3/T1Sweep/",
        "outerfoldernameT2": "Z:/t1Team/Data/2026-01-21_BFD_cooldown/DynOxd_Si/RFSOC/Q3/T2Sweep/",
    },
    "4": {
        ...
        "outerfoldernameT1": "Z:/t1Team/Data/2025-03-06_BFD_cooldown/TATQ01-KI-02/RFSoC/Q4/T1Sweep",
        "outerfoldernameT2": "Z:/t1Team/Data/2025-03-06_BFD_cooldown/TATQ01-KI-02/RFSoC/Q4/T2Sweep",
    },
    "5": {
        ...
        "outerfoldernameT1": "Z:/t1Team/Data/2025-03-06_BFD_cooldown/TATQ01-KI-02/RFSoC/Q5/T1Sweep",
        "outerfoldernameT2": "Z:/t1Team/Data/2025-03-06_BFD_cooldown/TATQ01-KI-02/RFSoC/Q5/T2Sweep",
    },
    "6": {
        ...
        "outerfoldernameT1": "Z:/t1Team/Data/2025-03-06_BFD_cooldown/TATQ01-KI-02/RFSoC/Q6/T1Sweep",
        "outerfoldernameT2": "Z:/t1Team/Data/2025-03-06_BFD_cooldown/TATQ01-KI-02/RFSoC/Q6/T2Sweep",
    },
}

T1_T2Equbitsweepswitch = True
T1T2E_params = {"qubit_swept": [1,2,4,5,6], 
                "T1_step_list": [5,5,5,5,5], 
                "T1_expts_list": [200,200,200,200,200], 
                "T1_reps_list": [15,15,15,15,15], 
                "T1_rounds_list": [15,15,15,15,15], 
                "T2_max_us_list": [400,400,400,400,400], 
                "T2_expts_list": [100,100,100,100,100], 
                "T2_reps_list": [15,15,15,15,15], 
                "T2_rounds_list":[15,15,15,15,15],
                "pi2_gain_list": [1480,510,260,1820,2680],
                "freq_shift": 0.0,
                "num_pulses_list": [1],
                "relax_delay": 1000}
...
if T1_T2Equbitsweepswitch:
    for rep in range(repetition_number):
        for i, num in enumerate(T1T2E_params["qubit_swept"]):
            ...
            for n in range(len(T1T2E_params["num_pulses_list"])):
                ...
                outerFolder = Qubit_Parameters[str(Qubit_Readout)]['outerfoldernameT2']
