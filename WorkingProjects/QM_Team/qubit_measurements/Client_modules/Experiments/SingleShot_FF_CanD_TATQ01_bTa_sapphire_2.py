...
# ############### Start Can D ############################
# Qubit_Parameters = {
#     '1': {'Readout': {'Frequency': 6671.35, 'Gain': 6500},
#           'Qubit': {'Frequency': 3134.5, 'Gain': 2800, "sigma": 0.1, "flattop_length": 0.8}, # pi:    , pi/2:
#           'outerfoldername':"Z:/t1Team/Data/2025-09-17_BFF_Cooldown/TATQ01-Topsil-02/RFSOC/Q1/"},
#     '2': {'Readout': {'Frequency': 6772.188, 'Gain': 6000},
#           'Qubit': {'Frequency': 3324.5, 'Gain': 5000, "sigma": 0.05, "flattop_length": 0.05}, # pi:    , pi/2:
#           'outerfoldername':"Z:/t1Team/Data/2025-09-17_BFF_Cooldown/TATQ01-Topsil-02/RFSOC/Q2/"},
#     '3': {'Readout': {'Frequency': 6873.176, 'Gain': 2000}, # 6903.14, 2000
#           'Qubit': {'Frequency': 3425.5, 'Gain': 9200, "sigma": 0.1, "flattop_length": 0.8},
#           'outerfoldername': "Z:/t1Team/Data/2025-09-17_BFF_Cooldown/TATQ01-Topsil-02/RFSOC/Q3/"},
#     '4': {'Readout': {'Frequency': 6955.42, 'Gain': 6000},
#           'Qubit': {'Frequency': 3522.9, 'Gain': 3400, "sigma": 0.08, "flattop_length": None}, # pi:    , pi/2:
#           'outerfoldername': "Z:/t1Team/Data/2025-09-17_BFF_Cooldown/TATQ01-Topsil-02/RFSOC/Q4/"},
#     '5': {'Readout': {'Frequency': 7079.62, 'Gain': 6500},
#           'Qubit': {'Frequency': 3741.21, 'Gain': 3500, "sigma": 0.1, "flattop_length": 0.8}, # pi:    , pi/2:
#           'outerfoldername': "Z:/t1Team/Data/2025-09-17_BFF_Cooldown/TATQ01-Topsil-02/RFSOC/Q5/"},
#     '6': {'Readout': {'Frequency': 7146.588, 'Gain': 2000},
#           'Qubit': {'Frequency': 3829.5, 'Gain': 4750, "sigma": 0.1, "flattop_length": 0.8}, # pi:    , pi/2:
#           'outerfoldername': "Z:/t1Team/Data/2025-09-17_BFF_Cooldown/TATQ01-Topsil-02/RFSOC/Q6/"},
#     }
# # ############### End Can D ############################
...
Qubit_Parameters = {
    '1': {'Readout': {'Frequency': 6776.485, 'Gain': 12000},
          'Qubit': {'Frequency': 2897.42, 'Gain': 4200, "sigma": 0.1, "flattop_length": 0.8},
          'outerfoldername':"Z:/t1Team/Data/2026-01-15_BFF_cooldown/TATQ01KI bTa Q1C2/RFSOC/Q1//"},
    '2': {'Readout': {'Frequency': 7032.417, 'Gain': 10000},
          'Qubit': {'Frequency': 3077.806, 'Gain': 4660, "sigma": 0.1, "flattop_length": 0.8},
          'outerfoldername':"Z:/t1Team/Data/2026-01-15_BFF_cooldown/TATQ01KI bTa Q1C2/RFSOC/Q2//"},
    '4': {'Readout': {'Frequency': 7294.965, 'Gain': 12000},
          'Qubit': {'Frequency': 2431.75, 'Gain': 2200, "sigma": 0.025, "flattop_length": 0.1},
          'outerfoldername': "Z:/t1Team/Data/2026-01-15_BFF_cooldown/TATQ01KI bTa Q1C2/RFSOC/Q4//"},
    '5': {'Readout': {'Frequency': 7370.190, 'Gain': 8000},
          'Qubit': {'Frequency': 2643.210, 'Gain': 5800, "sigma": 0.075, "flattop_length": 0.6},
          'outerfoldername': "Z:/t1Team/Data/2026-01-15_BFF_cooldown/TATQ01KI bTa Q1C2/RFSOC/Q5//"},
    '6': {'Readout': {'Frequency': 7540.600, 'Gain': 7000},
          'Qubit': {'Frequency': 2735.350, 'Gain': 4980, "sigma": 0.05, "flattop_length": 0.4},
          'outerfoldername': "Z:/t1Team/Data/2026-01-15_BFF_cooldown/TATQ01KI bTa Q1C2/RFSOC/Q6//"},
}
############## End Can D ############################
...
Spec_relevant_params = {"qubit_gain": 1000, "SpecSpan": 11, "SpecNumPoints": 51,
                        "reps": 10, 'rounds': 10,
                        'Gauss': False, "sigma": 0.5, "gain": 500} # False -- no pulse #If you don't see RabiAmp but with Gauss True see the qubit, the next thing to check is gain, you might not have the right pi pulse
...
Amplitude_Rabi_params = {"qubit_freq": Qubit_Parameters[str(Qubit_Pulse)]['Qubit']['Frequency'],
                         ...
                         "reps": 10, 'rounds': 10,
                         'relax_delay': 4000}  #Always change the max gain if you don't see it, also compare what you get with Transmission data

RunT1 = False
RunT2 = False
T1T2_params = {"T1_step": 30, "T1_expts": 100, "T1_reps": 15, "T1_rounds": 15,
               "T2_step": 10, "T2_expts": 100, "T2_reps": 20, "T2_rounds": 20, "freq_shift": 0.2,
               "relax_delay": 3000,
               'repetitions': 1}

RunT2E = False
T2E_params = {"T2_max_us": 3000, "T2_expts": 100, "T2_reps": 15, "T2_rounds": 15, "freq_shift": 0.0,
...
RunT1SS = False
T1SS_params = {"T1_step": 10, "T1_expts": 100,
               "reps": 2000,
               'angle': 0, 'threshold': 0,
               "relax_delay": 10000,
               'calibrate_SS': True,
...
SS_R_params = {"gain_start": 20000, "gain_stop": 35000, "gain_pts": 9, "span": 0.5, "trans_pts": 9}

SingleShot_QubitOptimize = False #gain_span is now in percent
SS_Q_params = {"q_gain_span": 0.1, "q_gain_pts": 7, "q_freq_span": 0.1, "q_freq_pts": 7,
