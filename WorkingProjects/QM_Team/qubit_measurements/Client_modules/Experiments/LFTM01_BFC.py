...
Qubit_Parameters = {
    '1': {'Readout': {'Frequency': 4700.42667, 'Gain': 900}, #900 seems to be consistent # res found again
          'Qubit': {'Frequency': 1263.08, 'Gain': 6160,'pi2_Gain' : 3080, "sigma": 0.3, "flattop_length": None}, # qubit found again previous frequency 1263.228
          'outerfoldername':"V:/t1Team/Data/2026-3-9_BFC_Cooldown/LFTM01/RFSOC/Q1//"},# 2840
    '2': {'Readout': {'Frequency': 4909.55, 'Gain': 140}, # 250 is too much
          'Qubit': {'Frequency': 1144.823019, 'Gain': 6083, 'pi2_Gain' : 6083 // 2, "sigma": 0.06, "flattop_length": None}, # pi pulse gain: 4164
...
Spec_relevant_params = {"qubit_gain": 100, "SpecSpan": 0.5, "SpecNumPoints": 101,
                        "reps": 10, 'rounds': 10,
                        'Gauss': False, "sigma": 1, "gain": 1000} # False -- no pulse #If you don't see RabiAmp but with Gauss True see the qubit, the next thing to check is gain, you might not have the right pi pulse
...
Amplitude_Rabi_params = {"qubit_freq": Qubit_Parameters[str(Qubit_Pulse)]['Qubit']['Frequency'],
                         ...
                         "reps": 10, 'rounds': 10,
                         'relax_delay': 6000}  #Always change the max gain if you don't see it, also compare what you get with Transmission data
...
T1T2_params = {"T1_step": 60, "T1_expts": 60, "T1_reps": 20, "T1_rounds": 20, # 80 100 30 30
               "T2_step": 1, "T2_expts": 400, "T2_reps": 21, "T2_rounds": 21, "freq_shift": 0.0,
               "relax_delay": 5000,
               'repetitions': 3000}
...
T2E_params = {"T2_max_us": 3600, "T2_expts": 101, "T2_reps": 25, "T2_rounds": 25, "freq_shift": 0.0,
               "relax_delay": 4200, 'num_pi_pulses': 1, #need odd number of pulses
              "rotation_angle": None,
              "min_max": None,
              'repetitions': 3000}
...
SS_R_params = {"gain_start": 450, "gain_stop": 540, "gain_pts": 20, "span": 0.01, "trans_pts": 11}

SingleShot_QubitOptimize = False
SS_Q_params = {"q_gain_span": 40, "q_gain_pts": 21, "q_freq_span": 0.1, "q_freq_pts": 11,
