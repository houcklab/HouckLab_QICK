...
class MixedShots:
    ...
    def _DoubleGausFit(self):
        ...
        self.Blob1_area = np.trapezoid(self.Blob1GaussFit, self.FitX)
        self.Blob2_area = np.trapezoid(self.Blob2GaussFit, self.FitX)
        Overlap_area = np.trapezoid(self.OverlapFit, self.FitX)
