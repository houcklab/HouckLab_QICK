...
# in order of resonator length: Q1, Q2, Q4, Q3
Qubit_Parameters = {
    '1': {'Readout': {'Frequency': 7000.2 - mixer_freq - BaseConfig["cavity_LO"] / 1e6, 'Gain': 8000,
                      "FF_Gains": [0, 0, 0, 0], "Readout_Time": 2.5, "ADC_Offset": 0.3, 'cavmin': True},
          'Qubit': {'Frequency': 5000, 'Gain': 1060},
          'Pulse_FF': [0, 0, 0, 0]},
    '2': {'Readout': {'Frequency': 7106.3 - mixer_freq - BaseConfig["cavity_LO"] / 1e6, 'Gain': 2200,
                      "FF_Gains": [0, 0, 0, 0], "Readout_Time": 2.5, "ADC_Offset": 0.3, 'cavmin': True},
          'Qubit': {'Frequency': 4675.6, 'Gain': 2700},
          'Pulse_FF': [0, 0, 0, 0]},
    '3': {'Readout': {'Frequency': 7262.2 - mixer_freq - BaseConfig["cavity_LO"] / 1e6, 'Gain': 3000,
                      "FF_Gains": [0, 0, 0, 0],  "Readout_Time": 2.5, "ADC_Offset": 0.3, 'cavmin': True},
          'Qubit': {'Frequency': 4932.7, 'Gain': 4400},
          'Pulse_FF': [0, 0, 0, 0]},
    '4': {'Readout': {'Frequency': 7195.55 - mixer_freq - BaseConfig["cavity_LO"] / 1e6, 'Gain': 4000,
                      "FF_Gains": [0, 0, 0, 0], "Readout_Time": 2.5, "ADC_Offset": 0.3, 'cavmin': True},
          'Qubit': {'Frequency': 5233.5, 'Gain': 1450},
          'Pulse_FF': [0, 0, 0, 0]}
...
Run2ToneSpec = False
Spec_relevant_params = {"qubit_gain": 1200, "SpecSpan": 70, "SpecNumPoints": 81, 'Gauss': False, "sigma": 0.05,
                        "gain": 7000, 'reps': 20, 'rounds': 20}
...
#                "relax_delay": 500}
T1T2_params = {"T1_step": 0.3, "T1_expts": 200, "T1_reps": 30, "T1_rounds": 30,
               "T2_step": 0.015, "T2_expts": 200, "T2_reps": 30, "T2_rounds": 30, "freq_shift": 3.85, "angle_shift": 0,
               "relax_delay": 250}
T2E_params = {"T2_step":0.015, "T2_expts": 200, "T2_reps": 50, "T2_rounds": 50, "freq_shift": 0,
               "relax_delay": 250,
               "pi2_gain": 1350}
...
SS_Q_params = {"Optimize_Index": 0, "q_gain_span": 2000, "q_gain_pts":11, "q_freq_span": 5, "q_freq_pts": 11,
               'number_of_pulses': 1}
