...
outerFolder = "Z:\\t1Team\\Data\\2024-08-09_cooldown\\TATQ01-Si_01SS\\6p9328\\"
...
Qubit_Parameters = {
    ...
    '2': {'Readout': {'Frequency': 6846.4, 'Gain': 1200},
          ...
          'Pulse_FF': [0, 0, 0, 0]},
    '3': {'Readout': {'Frequency': 6932.74, 'Gain': 2000},
          'Qubit': {'Frequency': 3417.4, 'Gain': 4100},
          'Pulse_FF': [0, 0, 0, 0]},
    '4': {'Readout': {'Frequency': 7013.8, 'Gain': 2000},
          'Qubit': {'Frequency': 3405.6, 'Gain': 6270},
          'Pulse_FF': [0, 0, 0, 0]},
    '5': {'Readout': {'Frequency': 7153.9, 'Gain': 2000},
          'Qubit': {'Frequency': 3377.28, 'Gain': 10000},
          'Pulse_FF': [0, 0, 0, 0]},
    '6': {'Readout': {'Frequency': 7218.95, 'Gain': 1500},
          'Qubit': {'Frequency': 3799.9, 'Gain': 1340},
          'Pulse_FF': [0, 0, 0, 0]}
    }
# Readout
Qubit_Readout = 4
...
SingleShot = False
SS_params = {"Shots": 2000, "Readout_Time": 20, "ADC_Offset": 0.5}
