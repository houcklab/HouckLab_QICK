...
Qubit_Parameters = {
    '1': {'Readout': {'Frequency': 6773.159, 'Gain': 2000},
          'Qubit': {'Frequency': 3015.92, 'Gain': 1530}, # pi 1530, pi/2
          'Pulse_FF': [0, 0, 0, 0],
          'outerfoldername': "Z:\\t1Team\\Data\\2025-07-31_BFG_cooldown\\TATQ01-bTa\\RFSOC\\Q1\\"},
    '2': {'Readout': {'Frequency': 7031.003, 'Gain': 1000},
          'Qubit': {'Frequency': 3192.36, 'Gain': 410}, # pi 410, pi/2
          'Pulse_FF': [0, 0, 0, 0],
          'outerfoldername': "Z:\\t1Team\\Data\\2025-07-31_BFG_cooldown\\TATQ01-bTa\\RFSOC\\Q2\\"},
    '3': {'Readout': {'Frequency': 7043.985, 'Gain': 1000},
          'Qubit': {'Frequency': 2809.986, 'Gain': 3950}, # pi 3950, pi/2
          'Pulse_FF': [0, 0, 0, 0],
          'outerfoldername': "Z:\\t1Team\\Data\\2025-07-31_BFG_cooldown\\TATQ01-bTa\\RFSOC\\Q3\\"},
    '4': {'Readout': {'Frequency': 7293.236, 'Gain': 1000},
          'Qubit': {'Frequency': 2612.54, 'Gain': 220}, # pi 220, pi/2
          'Pulse_FF': [0, 0, 0, 0],
          'outerfoldername': "Z:\\t1Team\\Data\\2025-07-31_BFG_cooldown\\TATQ01-bTa\\RFSOC\\Q4\\"},
    '5': {'Readout': {'Frequency': 7365.641, 'Gain': 1000},
          'Qubit': {'Frequency': 2798.44, 'Gain': 1100}, # pi 1100, pi/2
          'Pulse_FF': [0, 0, 0, 0],
          'outerfoldername': "Z:\\t1Team\\Data\\2025-07-31_BFG_cooldown\\TATQ01-bTa\\RFSOC\\Q5\\"},
    '6': {'Readout': {'Frequency': 7537.501, 'Gain': 2000},
          'Qubit': {'Frequency': 2878.63, 'Gain': 565}, # pi 565, pi/2
          'Pulse_FF': [0, 0, 0, 0],
          'outerfoldername': "Z:\\t1Team\\Data\\2025-07-31_BFG_cooldown\\TATQ01-bTa\\RFSOC\\Q6\\"},
}
# Readout
Qubit_Readout = 6
Qubit_Pulse = 6
...
Run2ToneSpec = False
Spec_relevant_params = {"qubit_gain": 200, "SpecSpan": 5, "SpecNumPoints": 51,
                        "reps": 10, 'rounds': 25,
                        'Gauss': False, "sigma": 0.15, "gain": 30000}

RunAmplitudeRabi = False
Amplitude_Rabi_params = {"qubit_freq": Qubit_Parameters[str(Qubit_Pulse)]['Qubit']['Frequency'],
                         "sigma": 0.4, "max_gain": 3000,
                         "reps": 10, 'rounds': 25,}

RunT1 = False
RunT2 = False
T1T2_params = {"T1_step": 25, "T1_expts": 100, "T1_reps": 20, "T1_rounds": 25,
...
SS_R_params = {"gain_start": 1000, "gain_stop": 10000, "gain_pts": 11, "span": 2, "trans_pts": 11}
