...
class ConfigCodeEditor(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.code_text_editor.setPlaceholderText("Blocks socProxy imports. Works optimally with code that "
                                                 ...
                                                 "Extracts global config variable if present to send to configuration panel.")
    ...
    def run_script_blocking_funcs(self):
        ...
        try:
            ...
            try:
                ...
                QTimer.singleShot(2000, lambda: self.run_editor_button.setStyleSheet("image: url('assets/play-green.svg');"))
            except ValueError:
                pass
