...
class ExperimentClass:
    ...
    def plotter(cls, plot_widget, plots, data):
        """
        The method the Quarky GUI uses to perform the plotting. It takes data as a parameter an appends pyqtgraph
        plots to the GraphicsLayoutWidget parameter passed.

        :param plot_widget: The layout widget that pyqtgraph plots are appended to
        :type plot_widget: GraphicsLayoutWidget
        :param plots: A list of plots to append to
        :type plots: list
