        ...
        if self.connected and self.current_tab.experiment_obj is not None:
            if self.current_tab.experiment_obj.experiment_type == ExperimentClassPlus:
                ...
                if any(issubclass(cls, VoltageInterface) for cls in hardware_req):
                    ...
                    # self.global_config_panel.populate_tree(False)
...
#     """
#
#     def __init__(self, global_config_panel, voltage_interface_combo, parent):
#         super().__init__()
#         self.global_config_panel = global_config_panel
...
#         if "DACs" in self.global_config_panel.config["Experiment Config"]:
#             self.dacs_edit.setText(str(self.global_config_panel.config["Experiment Config"]["DACs"]))
#         else:
#             self.dacs_edit.setText("")
#
#         if "VoltageStart" in self.global_config_panel.config["Experiment Config"]:
#             self.start_edit.setText(str(self.global_config_panel.config["Experiment Config"]["VoltageStart"]))
#         else:
#             self.start_edit.setText(str(0.0))
#
#         if "VoltageStop" in self.global_config_panel.config["Experiment Config"]:
#             self.stop_edit.setText(str(self.global_config_panel.config["Experiment Config"]["VoltageStop"]))
#         else:
#             self.stop_edit.setText(str(0.0))
#
#         if "VoltageNumPoints" in self.global_config_panel.config["Experiment Config"]:
#             self.numPoints_edit.setText(str(self.global_config_panel.config["Experiment Config"]["VoltageNumPoints"]))
#         else:
...
#                         raise ValueError
#
#             self.global_config_panel.config["Experiment Config"]["DACs"] = dacs_list
...
#
#             length = max(len(self.global_config_panel.config["Experiment Config"]["DACs"]), 1)
...
#                     raise ValueError
#
#             self.global_config_panel.config["Experiment Config"]["VoltageStart"] = start_list
#             self.global_config_panel.populate_tree()
#         except ValueError:
...
#                     raise ValueError
#
#             self.global_config_panel.config["Experiment Config"]["VoltageStop"] = stop_list
#             self.global_config_panel.populate_tree()
#
#         except ValueError:
#             qDebug(f"The input is invalid. Please enter a comma-separated list of integers within valid voltage range and ensure length is same as DACs). Resetting.")
...
#             self.global_config_panel.config["Experiment Config"]["VoltageNumPoints"] = value
#             self.global_config_panel.populate_tree()
#         except ValueError:
...
#         self.parent = parent
#
#         if "Voltage Config" in self.global_config_panel.config:
#             if "Channels" not in self.global_config_panel.config["Voltage Config"]:
#                 qCritical("No Channels field found to Voltage Config.")
#             elif "VoltageMatrix" not in self.global_config_panel.config["Voltage Config"]:
#                 qCritical("No VoltageMatrix field found to Voltage Config.")
#
#         # the channel list is self.global_config_panel.config["Voltage Config"]["Channels"]
#         # the voltage matrix is at self.global_config_panel.config["Voltage Config"]["VoltageMatrix"]
#
...
#         voltage_config = self.global_config_panel.config.get("Voltage Config")
#         if voltage_config:
