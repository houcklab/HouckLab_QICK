...
from WTF.Client_modules.CoreLib.socProxy import *
from WTF.Client_modules.PythonDrivers.control_atten import setatten
...
BaseConfig={
        ...
        "pulse_freq": 893.54, # [MHz]
        # In this program the signal is up and downconverted digitally so you won't see any frequency
        # components in the I/Q traces below. But since the signal gain depends on frequency,
        # if you lower pulse_freq you will see an increased gain.
        "adc_trig_offset": 0.468-0.02 , #soc.us2cycles(0.468-0.02), # [Clock ticks]
        # Try varying adc_trig_offset from 100 to 220 clock ticks
        "cavity_LO": 6.5e9,
        ####define basic fast flux parameters
        "ff_pulse_style": "const", # -
        "ff_nqz": 1,  ### nq zone for the channel
        "ff_ch": 4,  #### fast flux channel
       }
