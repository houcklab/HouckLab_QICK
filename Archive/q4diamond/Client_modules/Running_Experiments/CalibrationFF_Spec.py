...
from q4diamond.Client_modules.Experiment_Scripts.mFFSpecCalibration import FFSpecCalibration
from q4diamond.Client_modules.Experiment_Scripts.mAmplitudeRabiFF import AmplitudeRabiFF
from OptimizedFFPulseArrays import vs_step_orig
...
# step values (gain in arbitrary units)
FF_gain1_step = gain_test  # Left Qubit
FF_gain2_step = 0  # Middle Qubit
FF_gain3_step = 0  # Right Qubit
FF_gain4_step = 0  # Right Qubit

FF_gain1_pulse = FF_gain1_step
FF_gain2_pulse = FF_gain2_step
FF_gain3_pulse = FF_gain3_step
FF_gain4_pulse = FF_gain4_step

# readout, same as step values
FF_gain1_read = FF_gain1_step
FF_gain2_read = FF_gain2_step
FF_gain3_read = FF_gain3_step
FF_gain4_read = FF_gain4_step
...
# Qubit_Parameters = {
#     '1': {'Readout': {'Frequency': 6952.79, 'Gain': 8000}, 'Qubit': {'Frequency': 4672, 'Gain': 1450}},
#     '2': {'Readout': {'Frequency': 7055.61, 'Gain': 6000}, 'Qubit': {'Frequency': 4558, 'Gain': 990}},
#     '3': {'Readout': {'Frequency': 7117.02, 'Gain': 6000}, 'Qubit': {'Frequency': 4390, 'Gain': 840}},
#     '4': {'Readout': {'Frequency': 7250.01, 'Gain': 6000}, 'Qubit': {'Frequency': 4700, 'Gain': 2630}}
#     }
...
Spec_relevant_params = {"qubit_gain": 500, "SpecSpan": 35, "SpecNumPoints": 91, 'Gauss': True, "sigma": 0.012,
                        "gain": 4900}
...
if Run2ToneSpec:
    ...
    Instance_specSlice = QubitSpecSliceFF(path="SpecSliceFF", cfg=config, soc=soc, soccfg=soccfg,
                                          outerFolder=outerFolder)
...
experiment = {
    ...
    "delayStep": 30 ,  # [clock cycles] = 0.00235 us each #FIXME CLOCK
    "DelayPoints": 50  # 400  # 28
}
# experiment = {
#     "delayStart": 0,  # [clock cycles] = 0.00235 us each #FIXME CLOCK
...
Instance_FFSpecCal = FFSpecCalibration(path="FFSpecCal", cfg=config, soc=soc, soccfg=soccfg,
