...
from q4diamond.Client_modules.Experimental_Scripts_MUX.mSpecSliceFFMUX_CW import QubitSpecSliceFFMUXCW
...
from q4diamond.Client_modules.Experimental_Scripts_MUX.mChiShiftMUX import ChiShift
...
Qubit_Parameters = {
    '1': {'Readout': {'Frequency': 6976.8 - mixer_freq - BaseConfig["cavity_LO"] / 1e6, 'Gain': 7000,
                      "FF_Gains": [0, 0, 0, 0], "Readout_Time": 2.5, "ADC_Offset": 0.3, 'cavmin': True},
          'Qubit': {'Frequency': 4947.9, 'Gain': 740},
          'Pulse_FF': [0, 0, 0, 0]},
    '2': {'Readout': {'Frequency': 7060 - mixer_freq - BaseConfig["cavity_LO"] / 1e6, 'Gain': 5500,
                      "FF_Gains": [0, 0, 0, 0], "Readout_Time": 2.5, "ADC_Offset": 0.3, 'cavmin': True},
          'Qubit': {'Frequency': 4905.8, 'Gain': 1610},
          # 'Qubit': {'Frequency': 4711.5, 'Gain': 1800},
          'Pulse_FF': [0, 0, 0, 0]},
    '3': {'Readout': {'Frequency': 7128.2 - mixer_freq - BaseConfig["cavity_LO"] / 1e6, 'Gain': 6500,
                      "FF_Gains": [0, 0, 0, 0], 'cavmin': True},
          'Qubit': {'Frequency': 5100.5, 'Gain': 1470},
          'Pulse_FF': [0, 0, 0, 0]},
    '4': {'Readout': {'Frequency': 7246.1 - mixer_freq - BaseConfig["cavity_LO"] / 1e6, 'Gain': 8000,
                      "FF_Gains": [0, 0, 0, 0], 'cavmin': True},
          'Qubit': {'Frequency': 4152.18, 'Gain': 1200},
          'Pulse_FF': [0, 0, 0, 0]}
    }
...
Run2ToneSpec = False
# Spec_relevant_params = {"qubit_gain": 2000, "SpecSpan": 200, "SpecNumPoints": 51, 'Gauss': False, "sigma": 0.05,
#                         "gain": 1230}
Spec_relevant_params = {"qubit_gain": 80, "SpecSpan": 3, "SpecNumPoints": 51, 'Gauss': False, "sigma": 0.05,
                        "gain": 1230}
...
T1T2_params = {"T1_step": 5, "T1_expts": 60, "T1_reps": 50, "T1_rounds": 20,
               "T2_step": 0.11, "T2_expts": 60, "T2_reps": 50, "T2_rounds": 20, "freq_shift": 1.3}

T1T2_params = {"T1_step": 3.5, "T1_expts": 60, "T1_reps": 50, "T1_rounds": 20,
               "T2_step": 0.8, "T2_expts": 150, "T2_reps": 50, "T2_rounds": 20, "freq_shift": 0.18}

SingleShot = False
# SS_params = {"Shots": 30000, "Readout_Time": 30, "ADC_Offset": 0.5, "Qubit_Pulse": Qubit_PulseSS}
SS_params = {"Shots": 1000, "Readout_Time": 2.5, "ADC_Offset": 0.5, "Qubit_Pulse": Qubit_PulseSS}

SingleShot_ReadoutOptimize = True
SS_R_params = {"gain_start": 3000, "gain_stop": 10000, "gain_pts": 15, "span": 1.2, "trans_pts": 13}
