...
yoko69.SetVoltage(0.087)
yoko70.SetVoltage(0.1908)
yoko71.SetVoltage(0.342)
yoko72.SetVoltage(-0.1283)

mixer_freq = 500
BaseConfig["mixer_freq"] = mixer_freq
Qubit_Parameters = {
    '1': {'Readout': {'Frequency': 6962.7 - mixer_freq - BaseConfig["cavity_LO"] / 1e6, 'Gain': 9000,
                      "FF_Gains": [0, 0, 0, 0], "Readout_Time": 2.5, "ADC_Offset": 0.3, 'cavmin': True},
          'Qubit': {'Frequency': 4588, 'Gain': 870},
          'Pulse_FF': [0, 0, 0, 0]},
    '2': {'Readout': {'Frequency': 7033.07 - mixer_freq - BaseConfig["cavity_LO"] / 1e6, 'Gain': 4000,
                      "FF_Gains": [0, 0, 0, 0], "Readout_Time": 2.5, "ADC_Offset": 0.3, 'cavmin': True},
          'Qubit': {'Frequency': 4600, 'Gain': 800},
          'Pulse_FF': [0, 0, 0, 0]},
    '3': {'Readout': {'Frequency': 7105.8 - mixer_freq - BaseConfig["cavity_LO"] / 1e6, 'Gain': 6500,
                      "FF_Gains": [0, 0, 0, 0], 'cavmin': True},
          'Qubit': {'Frequency': 4600, 'Gain': 1700},
          'Pulse_FF': [0, 0, 0, 0]},
    '4': {'Readout': {'Frequency': 7230.35 - mixer_freq - BaseConfig["cavity_LO"] / 1e6, 'Gain': 5500,
                      "FF_Gains": [0, 0, 0, 0], 'cavmin': True},
          'Qubit': {'Frequency': 5036, 'Gain': 1581},
          'Pulse_FF': [0, 0, 0, 0]}
    }
...
Run2ToneSpec = False
Spec_relevant_params = {"qubit_gain": 500, "SpecSpan": 50, "SpecNumPoints": 51, 'Gauss': True, "sigma": 0.05,
                        "gain": 948}
...
RunT1 = False
RunT2 = True
T1T2_params = {"T1_step": 3, "T1_expts": 50, "T1_reps": 50, "T1_rounds": 20,
               "T2_step": 0.15, "T2_expts": 50, "T2_reps": 30, "T2_rounds": 20, "freq_shift": 1}

SingleShot = False
SS_params = {"Shots": 2000, "Readout_Time": 2.5, "ADC_Offset": 0.5, "Qubit_Pulse": Qubit_Pulse}
...
SS_Q_params = {"Optimize_Index": 0, "q_gain_span": 1000, "q_gain_pts": 6, "q_freq_span": 3, "q_freq_pts": 10}
