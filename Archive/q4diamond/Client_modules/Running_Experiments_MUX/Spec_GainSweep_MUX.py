...
yoko69.SetVoltage(-0.0361)
yoko70.SetVoltage(-0.0298)
yoko71.SetVoltage(-0.1022)
yoko72.SetVoltage(-0.4455)
...
Qubit_Parameters = {
    ...
    '2': {'Readout': {'Frequency': 7033.5 - mixer_freq - BaseConfig["cavity_LO"] / 1e6, 'Gain': 6000,
          ...
          'Pulse_FF': [-8000, 7000,  15000, 0]},
    # '3': {'Readout': {'Frequency': 7104.9 - mixer_freq - BaseConfig["cavity_LO"] / 1e6, 'Gain': 6000,
    #                   "FF_Gains": [-8000, 9000,  17000, 0], 'cavmin': True},
    #       'Qubit': {'Frequency': 5028.5, 'Gain': 800},
    #       'Pulse_FF': [-8000, 7000,  15000, 0]},
    '3': {'Readout': {'Frequency': 7104.2 - 0.3 - mixer_freq - BaseConfig["cavity_LO"] / 1e6, 'Gain': 6500,
          ...
          'Pulse_FF': [0, 0, 0, 0]},
    # '4': {'Readout': {'Frequency': 7229.5 - mixer_freq - BaseConfig["cavity_LO"] / 1e6, 'Gain': 9000,
    #                   "FF_Gains": [0, 0, 0, 0], 'cavmin': True},
    #       'Qubit': {'Frequency': 4601, 'Gain': 3700},
    #       'Pulse_FF': [0, -200, 0, 0]}
    '4': {'Readout': {'Frequency': 7229.5 - mixer_freq - BaseConfig["cavity_LO"] / 1e6, 'Gain': 9000,
                      "FF_Gains": [0, 0, 0, 0], 'cavmin': True},
          'Qubit': {'Frequency': 4600, 'Gain': 2700},
          'Pulse_FF': [0, 0, 0, 0]}
    }
...
Run2ToneSpec = False
Spec_relevant_params = {"qubit_gain": 70, "SpecSpan": 10, "SpecNumPoints": 51, 'Gauss': True, "sigma": 0.05,
...
spec_gain_dict = {'sweep_qubit': 2, 'gainStart': -400, 'gainStop': -200, 'gainNumPoints': 5, #sweep qubit is 1 indexed
                  'relax_delay': 200, "qubit_gain": 0, "SpecSpan": 20, "SpecNumPoints": 161, 'Gauss': False, "sigma": 0.05,
