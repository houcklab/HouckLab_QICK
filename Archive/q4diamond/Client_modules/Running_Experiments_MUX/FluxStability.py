...
Qubit_Parameters = {
    '1': {'Readout': {'Frequency': 6962.65 - 1 - mixer_freq - BaseConfig["cavity_LO"] / 1e6, 'Gain': 7000, "FF_Gains": [0, 0, 0, 0], "Readout_Time": 2.5,
                      "ADC_Offset": 0.3},
          'Qubit': {'Frequency': 4797.8, 'Gain': 1200},
          'Pulse_FF': [0, 0, 0, 0]},
    '2': {'Readout': {'Frequency': 7060 - 0.15 - mixer_freq - BaseConfig["cavity_LO"] / 1e6, 'Gain': 9000, "FF_Gains": [0, 10500, 0, 0], "Readout_Time": 2.5, "ADC_Offset": 0.3},
...
Spec_relevant_params = {"qubit_gain": 40, "SpecSpan": 1.5, "SpecNumPoints": 41, 'Gauss': False, "sigma": 0.05,
                        "gain": 4900}
Amplitude_Rabi_params = {"qubit_freq": Qubit_Parameters[str(Qubit_Pulse)]['Qubit']['Frequency'],
                         "sigma": 0.012, "max_gain": 8000}
Flux_Stability_params = {'delaystep': 3, 'delaypoints': 190, 'Gauss': False}
