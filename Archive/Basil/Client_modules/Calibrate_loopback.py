...
cavityAtten = attenuator(27786, attenuation_int= 35, print_int = False)
qubitAtten = attenuator(27796, attenuation_int= 20, print_int = False)
...
while i < 1:
    ...
    Instance = Transmission(path="ZCollected_Data/dataTestTransmission", cfg=config, soc=soc, soccfg=soccfg)
