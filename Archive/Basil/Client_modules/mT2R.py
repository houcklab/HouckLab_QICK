from qick import *
from Basil.Client_modules.socProxy import makeProxy
...
class T2RProgram(RAveragerProgram):
    def initialize(self):
        ...
        self.add_gauss(ch=cfg["qubit_ch"], name="qubit", sigma=self.us2cycles(cfg["sigma"], gen_ch=cfg["qubit_ch"]),
                       length=self.us2cycles(cfg["sigma"] * 4, gen_ch=cfg["qubit_ch"]))
