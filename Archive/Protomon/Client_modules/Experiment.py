...
class ExperimentClass:
    ...
    def __init__(self, path='', prefix='data', soc=None, soccfg=None, cfg = None, config_file=None, liveplot_enabled=False, **kwargs):
        ...
        self.fname = os.path.join(self.path, datetimestring + "_" + self.prefix + '.h5')
        self.iname = os.path.join(self.path, datetimestring + "_" + self.prefix + '.png')
        # print(self.fname)
        #self.load_config()
    #
