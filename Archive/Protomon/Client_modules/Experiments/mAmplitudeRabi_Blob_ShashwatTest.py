...
from Protomon.Client_modules.Experiments.mAmplitudeRabi_ShashwatTest import LoopbackProgramAmplitudeRabi
...
class AmplitudeRabi_Blob(ExperimentClass):
    ...
    def acquire(self, progress=False, debug=False, plotDisp = True, plotSave = True, figNum = 1):
        ...
        expt_cfg = {
            ...
            "qubit_freq_start": self.cfg["qubit_freq_start_rabiBlob"],
            "qubit_freq_stop": self.cfg["qubit_freq_stop_rabiBlob"],
            "RabiNumPoints": self.cfg["qubit_freq_expts_rabiBlob"],  ### number of points
            ### rabi amp parameters
        ...
        print("qubit freqs = ", self.qubit_freqs)
