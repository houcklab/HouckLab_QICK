...
from LabCode2.CoreLib.Experiment import ExperimentClass
from LabCode2.Helpers.qick_helpers import measure_1q
from qick import *
from qick import helpers
import Pyro4.util
import LabCode2.Helpers.fit_functions as fitters
import h5py
import numpy as np
import matplotlib.pyplot as plt
...
outerFolder = "Z:\Shashwat\Protomon\FMV8_TD\dataTestSpecVsFlux\dataTestSpecVsFlux_2023_05_14\\"
#outerFolder = outerFolder + '\\dataTestSpecVsFlux\\dataTestSpecVsFlux_2022_09_21\\'
fileName = outerFolder + 'dataTestSpecVsFlux_2023_05_14_21_42_43_data.h5'
# Look at a data file
with h5py.File(fileName, "r") as f:
    ...
    for i in range(len(voltVec)):
        ...
        avgphase = np.arctan2(specdata_Q[i, :], specdata_I[i, :]) - np.mean(
            np.arctan2(specdata_Q[i, :], specdata_I[i, :]))
        Z_spec1[i, :] = avgphase
